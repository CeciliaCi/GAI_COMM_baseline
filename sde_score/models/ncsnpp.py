"""
NCSN++ model from https://github.com/yang-song/score_sde_pytorch.
"""
...
class NCSNpp(nn.Module):
  ...
  def __init__(self, config):
    ...
    self.all_resolutions = all_resolutions = [config.data.image_size[0] // (2 ** i) for i in range(num_resolutions)]
